...
import { BindMethods } from "../decorators/bindMethods";
...
export const SynologyApiMethods = {
  [AudioStation.SPELLING_KEY]: AudioStation.METHODS,
  [AudioStation.SIMPLIFY_KEY]: AudioStation.METHODS,
  [FileStation.SPELLING_KEY]: FileStation.METHODS,
  [FileStation.SIMPLIFY_KEY]: FileStation.METHODS,
  [VideoStation.SPELLING_KEY]: VideoStation.METHODS,
  [VideoStation.SIMPLIFY_KEY]: VideoStation.METHODS,
  [Auth.SPELLING_KEY]: Auth.METHODS,
};
